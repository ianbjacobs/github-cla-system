...
export async function onSigningIssue(github, input) {
  const cfg = await config(github);
...
export async function onDefaultBranchPush(github) {
  const cfg = await config(github);
...
export async function onAgreementPullRequestMerged(github, input) {
